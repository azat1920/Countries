...
public class ClassicMode extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.classicmode_layout);
    ...
    private HashMap<Integer, Country> MakeNewList() {
        ...
        list.put(num.get(i), new Country((int) num.get(i), db));
        }
    ...
    private void Initialize(){
        ...
        btn1 = (Button) findViewById(R.id.cm_btn1);
        btn2 = (Button) findViewById(R.id.cm_btn2);
        btn3 = (Button) findViewById(R.id.cm_btn3);
        btn4 = (Button) findViewById(R.id.cm_btn4);
        tv1 = (TextView) findViewById(R.id.cm_tv1);
        tv2 = (TextView) findViewById(R.id.cm_tv2);
        tv3 = (TextView) findViewById(R.id.cm_tv3);
        tv4 = (TextView) findViewById(R.id.cm_tv4);
        prb = (ProgressBar) findViewById(R.id.cm_prb);
    ...
    class ShowDialog extends AsyncTask<Void, Boolean, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (count < maxNum ) {
                ...
                if (s.equals(list.get(num.get(count)).getCapital().toLowerCase())){
                    rightSum++;
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (count == maxNum) {
                ...
                tv2.setText(String.format("%d", rightSum));
                tv3.setText(String.format("%d", wrongSum));
                Button btn5 = (Button) findViewById(R.id.cm_btn5);
