...
public class ManuallyCountries extends Activity {
    ...
    class ShowDialog extends AsyncTask<Void, Boolean, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (count < maxNum) {
                ...
                if (s.equals(list.get(num.get(count)).getCountry().toLowerCase().trim())) {
                    RightSum++;
        ...
        protected void onProgressUpdate(Boolean... values) {
            ...
            if (checked) {
                ...
                if (b) {
                    ...
                    if (s1.equals(list.get(num.get(count)).getCountry().toLowerCase().trim()))
                        btn2.setBackgroundColor(getResources().getColor(R.color.my_green));
                    et.setText(list.get(num.get(count)).getCountry());
